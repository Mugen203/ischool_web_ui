...
/**
 * GPAOverview Component
 *
 * Comprehensive dashboard displaying student's academic performance metrics.
 * Features include:
 * - Cumulative GPA with visual progress indicator
 * - Credit hours and course completion tracking
 * - Current semester progress and statistics
 * - Academic standing and graduation timeline
 * - GPA trend visualization
 * - Target GPA tracking
 *
 * The component is organized in three main sections:
 * 1. Key performance metrics (top row)
 * 2. GPA chart and current semester details (middle row)
 * 3. Additional academic metrics (bottom row)
 *
 * @component
 * @example
 * ```tsx
...
export function GPAOverview() {
  /** All courses taken by the student across all terms */
  const allCourses = Object.values(grades).flat();

  /**
   * Calculates the GPA progress as a percentage of maximum GPA (4.0)
