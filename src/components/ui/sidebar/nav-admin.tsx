  ...
  userManagement: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Add Lecturer",
          url: "/admin/lecturers/add",
          icon: UserPlus,
          roles: ["Administrator"],
        },
        {
          title: "Edit Lecturer",
          url: "/admin/lecturers/edit",
          icon: FileEdit,
          roles: ["Administrator"],
        },
        {
          title: "Remove Lecturer",
          url: "/admin/lecturers/remove",
          icon: UserMinus,
          roles: ["Administrator"],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "View Grademasters",
          url: "/admin/grademasters",
          icon: UserCheck,
          roles: ["Administrator"],
        },
        {
          title: "Add Grademaster",
          url: "/admin/grademasters/add",
          icon: UserPlus,
          roles: ["Administrator"],
        },
        {
          title: "Edit Grademaster",
          url: "/admin/grademasters/edit",
          icon: FileEdit,
          roles: ["Administrator"],
        },
        {
          title: "Remove Grademaster",
          url: "/admin/grademasters/remove",
          icon: UserMinus,
          roles: ["Administrator"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          title: "Edit Dean",
          url: "/admin/deans/edit",
          icon: FileEdit,
          roles: ["Administrator"],
        },
        {
          title: "Remove Dean",
          url: "/admin/deans/remove",
          icon: UserMinus,
          roles: ["Administrator"],
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/admin/administrators/remove",
          icon: UserMinus,
          roles: ["Administrator"],
        },
      ],
  ...
  academic: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Edit Program",
          url: "/admin/programs/edit",
          icon: FileEdit,
          roles: ["Administrator"],
        },
        {
          title: "Remove Program",
          url: "/admin/programs/remove",
          icon: FileMinus,
          roles: ["Administrator"],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "View Class Enrollment",
          url: "/admin/class-enrollment",
          icon: ListChecks,
          roles: ["Administrator"],
        },
        {
          title: "Edit Class Enrollment",
          url: "/admin/class-enrollment/edit",
          icon: FileEdit,
          roles: ["Administrator"],
        },
      ],
  ...
  facilities: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: "/admin/classrooms/remove",
          icon: FileMinus,
          roles: ["Administrator"],
        },
        {
          title: "Schedules",
          url: "/admin/classrooms/schedules",
          icon: Calendar,
          roles: ["Administrator"],
        },
      ],
  ...
  return (
    <>
      <SidebarGroup>
        ...
        <SidebarMenu>{adminNavGroups.main.map(renderMenuItem)}</SidebarMenu>
      </SidebarGroup>
      ...
      <SidebarGroup>
        ...
        <SidebarMenu>{adminNavGroups.academic.map(renderMenuItem)}</SidebarMenu>
      </SidebarGroup>
      ...
      <SidebarGroup>
        ...
        <SidebarMenu>{adminNavGroups.system.map(renderMenuItem)}</SidebarMenu>
      </SidebarGroup>
    </>
  );
}
